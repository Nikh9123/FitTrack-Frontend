 ...
 * Includes a trash icon button (top-right) to trigger deletion.
 */
...
interface ReportCardProps {
  ...
  onDelete?: (report: InBodyReport) => void;
}
...
export default function ReportCard({ report, onPress, onDelete }: ReportCardProps) {
